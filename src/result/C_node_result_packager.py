...
- title은 단 한 번만 출력할 것. (설명 문장 안에 title 반복 금지)
- "제목: " 과 같은 라벨 금지
- **title은 반드시 명사구로만 작성할 것 ("~하다", "~하기", "~하는 것" 등 동사/동명사로 title 끝맺음 금지)**
- **title이 여러 개일 경우 개별 항목을 정확히 구분할 수 있도록 구체적이고 차별화되게 작성할것. (서로 완전히 동일한 title 금지)**
